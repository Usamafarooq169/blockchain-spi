  ...
  <div id="wrap">
      ...
      <div class="container">
        ...
        <nav class="navbar ownmenu navbar-expand-lg ">
          <button class="navbar-toggler collapsed" type="button" data-toggle="collapse" data-target="#navbarNav"
            aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation"> <span><i
    ...
    <section class="simple-head" data-stellar-background-ratio="0.5" id="hme">
      ...
      <div class="position-center-center" >
        <div class="container text-center">
          ...
          <h1>You have already Selected a project to suggest Improvements </h1>
          <p>You can proceed with any of the given options Below.</p>
          <a href="./ExpProjList.php" class="btn" style="width: 250px;">Select A<br> New Project</a>
          <a href="./delivery.php" style="width: 250px;" onclick="openPage()" class="btn btn-inverse">Deliver <br> Completed Appraisal</a>
        </div>
      </div>
    </section>
    ...
    <footer id="contact" class="pt-4 pb-2 text-center">
      ...
      <img style="max-width:40px;"
        src="https://upload.wikimedia.org/wikipedia/en/thumb/f/fa/COMSATS_Logo.svg/1200px-COMSATS_Logo.svg.png" alt="">
    </footer>
  </div>
