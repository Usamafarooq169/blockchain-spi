        ...
        <div class="col-lg-12">
          <div class="contact" style="background-color: #dfe6e9;">
            ...
            <div class="container" style="background-color: #dfe6e9;">
              <h4 style="margin-left: -1.5%;"> Download/Vote for the Solution of project <u><i><?php echo $conPName; ?></i></u>
               by <u><?php echo $name; ?></u></h4>
              <form action="" method="POST" enctype="multipart/form-data">

                
                <div class="row">
                  <div class="col-25">
                    <label for="SRS">Download <u><?php echo $conPName; ?>'s</u> solution by <u><?php echo $name; ?></u> </label>
                  </div>
                  <div class="col-75">
                    <a href="downloadSolExp.php">
                      <label name="SRS" style="color:blue;"><u>Click here to download</u> </label>
                    </a>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-25">
                    <label for="guidelines">Vote for this solution: </label>
                  </div>
                  <div class="col-75">
                    <a href="recordVote.php" onclick="return confirm('Are you sure you want to vote for this solution?');">
                      <label name="SRS" style="color:blue;"><u>Click here</u> </label>
                    </a>
                  </div>
                </div>
