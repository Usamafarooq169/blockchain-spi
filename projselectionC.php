        ...
        <div class="col-lg-12">
          <div class="contact" style="background-color: #dfe6e9;">
            ...
            <div class="container" style="background-color: #dfe6e9;">
              <h4 style="margin-left: -1.5%;"> The project which You have selected is <u><i><?php echo $name; ?></i></u></h4>
              <form action="downloadFile.php" method="POST" enctype="multipart/form-data">

                <div class="row">
                  <div class="col-25">
                    <label for="DL">Desired Level of Improvement is: </label>
                  </div>
                  <div class="col-75">

                    <label name="DL">Level <?php echo $desLevel; ?></label>
                ...
                <div class="row">
                  <div class="col-25">
                    <label for="fname">Delivery Deadline: </label>
                  </div>
                  <div class="col-75">
                                     

                      <label name="fname"><?php echo$deadline;?> days</label>
                ...
                <div class="row">
                  <div class="col-25">
                    <label for="SRS">Download selected Project's SRS: </label>
                  </div>
                  <div class="col-75">
                    <a href="downloadFile.php">
                      <label name="SRS" style="color:blue;"><u>Click here to download SRS</u> </label>
                    </a>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-25">
                    <label for="guidelines">Download Guidelines & Template of Appraisal for the selected project: </label>
                  </div>
                  <div class="col-75">
                    <a href="guidelines.php">
                      <label name="SRS" style="color:blue;"><u>Click here to download Guidelines & Template</u> </label>
                    </a>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-25">
                    <label for="delivery"> Completed your previously assigned task? Ready to Deliver? </label>
                  </div>
                  <div class="col-75">
                    <a href="delivery.php">
                      <label name="delivery" style="color:blue;"><u>Click here to Proceed towards delivery of appraisal</u> </label>
                    </a>
                  </div>
                </div>
